...
{
    protected $fillable = ['id', 'marca', 'modelo', 'procesador', 'memoria_ram', 'disco_duro', 'pantalla', 'licencias', 'anio_adquicision', 'natural_id', 'juridica_id', 'propietario', 'created_at', 'updated_at'];
