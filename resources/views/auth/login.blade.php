...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
    ...
    <!-- Canonical SEO -->
    <link rel="canonical" href="https://pctools.nikorriendo.com"/>
    <!--  Social tags      -->
    <meta name="keywords"
          content="pctools, tickets, mantenimeiento">
    <meta name="description"
          content="PC-TOOLS">
    <!-- Schema.org markup for Google+ -->
    <meta itemprop="name" content="mantenimientos de computadores">
            ...
            <ul class="navbar-nav">
                <li class="nav-item ">
                    <a href="{{route('register')}}" class="nav-link">
                        <i class="material-icons">person_add</i> Solicitar Ticket
                    </a>
                </li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
                    <form id="sign_in" class="form-horizontal" method="POST" action="{{route('login')}}">
                        ...
                        <div class="card card-login card-hidden">
                            ...
                            <div class="card-body ">
                                <p class="card-description text-center">Tickets</p>
