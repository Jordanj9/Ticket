<html>
<head>
    <link rel="shortcut icon" href="{{asset('assets/img/upclogo.png')}}">
    <style>
        body {
            font-size: 10px;
        }
...
<body>
<div class="container">
    Fecha de Generación: {{$fecha}} - PCTOOLS  Nit:1096197954 - Barrancabermeja
    <div class="row" style="border-top: 1px solid">
        <table style="width: 100%">
            <tr>
                <td style="width: 15%;">
                    <img width="80px" height="80px" src="{{asset('assets/img/upclogo.png')}}"/>
                </td>
