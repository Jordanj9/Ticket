            ...
            <div class="col-md-12">
                <p class="animated fadeInDown">
                    <a href="{{route('inicio')}}">Inicio </a><span class="fa-angle-right fa"></span><a
                        ...
                        class="fa-angle-right fa"></span><a href="{{route('usuario.index')}}">Usuarios del Sistema
                    </a><span class="fa-angle-right fa"></span> Crear
                </p>
            </div>
        </div>
    </div>
                        ...
                        <form class="form-horizontal" method="POST" action="{{route('usuario.store')}}">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <br/><input type="text" class="form-control"
                                                    placeholder="Escriba los nombres del usuario" name="nombres"
                                                    id="txt_nombres" required="required"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-line">
                                        <br/><input type="text" class="form-control"
                                                    placeholder="Escriba los apellidos del usuario" name="apellidos"
                                                    id="txt_apellidos" required="required"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-line">
                                        <br/><input type="email" class="form-control"
                                                    ...
                                                    id="txt_email" required="required"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <br/><select class="form-control selectpicker" data-style="select-with-transition" name="estado"
                                                     placeholder="-- Seleccione Estado del Usuario --" required="">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <br/><select class="form-control show-tick select2" name="grupos[]"
                                                     placeholder="Seleccione los Grupos o Roles de Usuarios" required=""
                                                     multiple="">
